...
<script type="text/javascript">
   ...
   function parametersChanged() {
       document.getElementsByName('targetForm')[0].numberOfRowsChanged.value = true;
   }
</script>
<html:form action="/target">
    ...
    <div class="list_settings_container">
        <div class="filterbox_form_button"><a href="#" onclick="parametersChanged(); document.targetForm.submit(); return false;"><span><bean:message key="button.Show"/></span></a></div>
