...
<script type="text/javascript">
    ...
    function parametersChanged() {
        document.getElementsByName('userFormEditForm')[0].numberOfRowsChanged.value = true;
    }
</script>
<html:form action="/userform">
    ...
    <div class="list_settings_container">
        <div class="filterbox_form_button"><a href="#"
                                              onclick="parametersChanged(); document.userFormEditForm.submit(); return false;"><span><bean:message
...
<display:table class="list_table" id="userform" name="userformlist" pagesize="${userFormEditForm.numberofRows}"
               requestURI="/userform.do?action=${ACTION_LIST}&__fromdisplaytag=true&numberofRows=${userFormEditForm.numberofRows}"
               excludedParams="*">
    <display:column headerClass="forms_head_name header" class="name" titleKey="Form" sortable="true"
                    sortProperty="formName">
        <span class="ie7hack">
    ...
    <display:column headerClass="forms_head_desc header" class="description" titleKey="default.description"
