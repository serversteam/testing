<%@ page language="java" contentType="text/html; charset=utf-8" import="org.agnitas.util.AgnUtils, org.agnitas.web.MailloopForm, java.util.Locale"  errorPage="/error.jsp" %>
