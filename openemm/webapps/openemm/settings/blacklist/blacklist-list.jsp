<%-- checked --%>
<%@ page language="java" contentType="text/html; charset=utf-8" import="org.agnitas.beans.BlackListEntry, org.agnitas.web.BlacklistAction, java.net.URLEncoder"  errorPage="/error.jsp" %>
...
<div class="list_settings_container">
    <div class="filterbox_form_button"><a href="#" onclick="parametersChanged(); document.forms[0].action.value=${ACTION_LIST}; document.blacklistForm.submit(); return false;"><span><bean:message key="button.Show"/></span></a></div>
